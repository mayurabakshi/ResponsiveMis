            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="links span8">
                        <a class="home" href="www.nitt.edu" rel="tooltip" data-placement="bottom" data-original-title="NITT Site"></a>
                        <a class="blog" href="logout.php" rel="tooltip" data-placement="bottom" data-original-title="Logout"></a>
                    </div>
                </div>
            </div>
        </div>
...
<table width="500" border="1" cellspacing="5" class="table">
 <tr>
<th scope="row" colspan="5"><font face="Ebrima" color="#eb4141" size="+1">STUDENT INFORMATION</font></th>
  ...
  <tr>
    ...
    <td><?php echo $row['rollno'];?></td>
        ...
        <th><font color="#eb4141" face="Ebrima">ID No</font></th>
        <td><?php echo $row['stud_id'];?></td>
  </tr>
  <tr>
    <th scope="row"><font color="#eb4141" face="Ebrima">Name</font></th>
    <td><?php echo $row['name'];?></td>
    
        <th><font color="#eb4141" face="Ebrima">Batch</font></th>
        <td><?php echo $row['batch'];?></td>
  </tr>
  <tr>
    <th scope="row"><font color="#eb4141" face="Ebrima">Branch</font></th>
    <td><?php echo $row['branch'];?></td>
   
    <th><font color="#eb4141" face="Ebrima">Year</font></th>
    <td><?php echo $row['year'];?></td>
  </tr>
  <tr>
    <th scope="row"><font color="#eb4141" face="Ebrima">Semester</font></th>
    <td><?php echo $row['semester'];?></td>
    
    <th><font color="#eb4141" face="Ebrima">Hostel</font></th>
    <td><?php echo $row['hostel'];?></td>
  </tr>
  <tr>
    <th scope="row"><font color="#eb4141" face="Ebrima">Email</font></th>
    <td><?php echo $row['email'];?></td>
   
    <th><font color="#eb4141" face="Ebrima">Room No</font></th>
