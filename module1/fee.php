...
$q="select * from fee_details where rollno=".$_SESSION['user'];
$res=mysql_query($q);
...
<table width="500" border="1" cellspacing="5" class="table" style="width:auto">
 <tr>
<th scope="row" colspan="7"><font face="Ebrima" color="#eb4141" size="+1">Tution fees</font></th>
    
  </tr>

  <tr>
    <th scope="row"><font face="Ebrima" color="#eb4141">Semester</font></th>
    <td>I</td>
    <td>II</td>
    <td>III</td>
    <td>IV</td>
    ...
    <tr>
        <th><font color="#eb4141" face="Ebrima">Paid</font></th>
        <td><?php echo $row['tutionpaid'];?></td>
        <td><?php echo $row['tutionpaid'];?></td>
        <td><?php echo $row['tutionpaid'];?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
<table width="200" border="1" cellspacing="5" class="table" style="width:auto">
 <tr>
<th scope="row" colspan="7"><font face="Ebrima" color="#eb4141" size="+1">Hostel fees</font></th>
